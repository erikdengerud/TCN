...
python3 electricity/run_electricity.py --num_workers=4 --model_save_path='electricity/models/tcn_electrity_idun_3.pt' --writer_path='electricity/runs/electricity_idun_3' --epochs=700
